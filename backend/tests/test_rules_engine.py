...
def test_optional_statutory_verification_failure_does_not_fail():
    res = RuleEvaluator.evaluate_statutory_verification(
        requirement_id=5,
        rule_code="REQ-MSME-UDYAM-01",
        title="MSME/Udyam Registration",
        mandatory=False,
        verification_data={
            "status": "INACTIVE",
            "verified": False,
            "details": "Udyam registration not found"
        },
        source_name="Udyam Verification API",
...
def test_mandatory_statutory_verification_failure_is_fail():
    res = RuleEvaluator.evaluate_statutory_verification(
        requirement_id=6,
        rule_code="REQ-UDYAM-01",
